...
AFTER INSERT OR
DELETE ON "public"."team_memberships" FOR EACH ROW
...
AFTER INSERT OR
DELETE ON "public"."challenge_participants" FOR EACH ROW
...
CREATE TRIGGER validate_activity_challenge_agreement_trigger BEFORE INSERT OR
UPDATE ON "public"."activities" FOR EACH ROW
EXECUTE FUNCTION public.validate_activity_challenge_agreement ();
