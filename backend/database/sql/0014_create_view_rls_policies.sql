...
REVOKE
SELECT
    ON activity_details_view
FROM
    authenticated;

REVOKE
SELECT
    ON challenge_details_view
FROM
    authenticated;

REVOKE
SELECT
    ON discussion_post_details_view
FROM
    authenticated;

REVOKE
SELECT
    ON discussion_reply_details_view
FROM
    authenticated;

REVOKE
SELECT
    ON post_details_view
FROM
    authenticated;

REVOKE
SELECT
    ON team_details_view
FROM
    authenticated;
