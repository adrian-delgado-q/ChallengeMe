...
import {
    Box, VStack, HStack, Text, Input, IconButton, Button,
    Accordion, AccordionItem, AccordionButton, AccordionPanel, AccordionIcon,
    Badge, NumberInput, NumberInputField, NumberInputStepper, NumberIncrementStepper, NumberDecrementStepper
            ...
            <VStack align="stretch" spacing={4}>
                <Box>
                    ...
                    <Text fontSize="sm" color="gray.600" mb={4}>
                        Define progressive milestones for each activity type. Participants will work towards these goals as they log activities.
                    </Text>
                </Box>
                ...
                <Accordion allowMultiple defaultIndex={[0]}>
                    {selectedActivityTypes.map((activityType) => {
                        ...
                        return (
                            <AccordionItem key={activityType.id} border="1px solid" borderColor="gray.200" borderRadius="md" mb={3}>
                                <AccordionButton
                                    bg="gray.50"
                                    _hover={{ bg: "gray.100" }}
                                    borderRadius="md"
                                    ...
                                    <VStack spacing={4} align="stretch">
                                        ...
                                        <Box p={3} bg="blue.50" borderRadius="md" borderLeft="4px solid" borderColor="blue.400">
                                            <Text fontSize="sm" color="blue.800">
                                                <strong>Tip:</strong> Create progressive milestones that motivate participants.
                                                For example: "Beginner" (10 {activityType.unit}), "Intermediate" (25 {activityType.unit}), "Advanced" (50 {activityType.unit}).
                                            </Text>
                                        </Box>
                                        ...
                                        <VStack spacing={3} align="stretch">
                                            {milestones.map((milestone, milestoneIndex) => (
                                                <Box key={milestoneIndex} p={3} border="1px solid" borderColor="gray.200" borderRadius="md" bg="gray.50">
                                                    <HStack spacing={3} align="end">
                                                        <VStack align="start" flex={1} spacing={2}>
                                                            ...
                                                            <Input
                                                                ...
                                                                onChange={(e) => onUpdateMilestone(activityType.id, milestoneIndex, 'name', e.target.value)}
