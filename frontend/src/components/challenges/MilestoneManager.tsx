      ...
      <VStack align="stretch" spacing={4}>
        <Box>
          ...
          <Text fontSize="sm" color="gray.600" mb={4}>
            Define progressive milestones for each activity type. Participants will work towards
            these goals as they log activities.
          </Text>
        </Box>
                  ...
                  <VStack spacing={4} align="stretch">
                    ...
                    >
                      <Text fontSize="sm" color="blue.800">
                        <strong>Tip:</strong> Create progressive milestones that motivate
                        participants. For example: "Beginner" (10 {activityType.unit}),
                        "Intermediate" (25 {activityType.unit}), "Advanced" (50 {activityType.unit}
                        ).
                      </Text>
                    </Box>
