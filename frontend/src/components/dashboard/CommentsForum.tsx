        ...
        return (
            <Card p={6}>
                ...
                <Text color="red.600">
                    ...
                    {permissions.banExpiresAt && ` Expires: ${formatDistanceToNow(parseISO(permissions.banExpiresAt), { addSuffix: true })}`}
                </Text>
            </Card>
        );
    }
        ...
        <VStack spacing={4} align="stretch">
            ...
            <Card p={4}>
                <VStack spacing={4} align="stretch">
                    ...
                    <HStack justify="space-between" align="center">
                        ...
                        {posts.length > 0 && (
                            <Text fontSize="xs" color="gray.500">
                                {posts.filter(p => p.isPinned).length > 0 && `${posts.filter(p => p.isPinned).length} pinned • `}
                                {posts.length} posts
                            </Text>
                        )}
                    </HStack>
                    ...
                    {permissions?.canPost && (
                        <HStack spacing={3} align="flex-start" bg={useColorModeValue('gray.50', 'gray.700')} p={3} borderRadius="md">
                            <Avatar
                ...
                <VStack align="stretch" flex="1" spacing={2}>
                    ...
                    <Collapse in={isReplying}>
                        <Box
                            ...
                            bg={useColorModeValue('orange.25', 'orange.900')}
                            borderRadius="sm"
                        >
        ...
        <Box ml={nestLevel * 3}>
            <HStack align="flex-start" spacing={2}>
                ...
                <VStack align="stretch" flex="1" spacing={1}>
                    ...
                    <Box bg={bgColor} p={2} borderRadius="sm" borderWidth="1px" borderColor={borderColor} fontSize="sm">
