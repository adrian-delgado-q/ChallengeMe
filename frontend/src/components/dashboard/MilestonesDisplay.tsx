                  ...
                  <VStack spacing={4} align="stretch">
                    ...
                    <VStack spacing={3} align="stretch">
                      {sortedMilestones.map((milestone, index) => {
                        ...
                        const isNext =
                          !isAchieved &&
                          (index === 0 || activityProgress >= sortedMilestones[index - 1]?.value);
                            ...
                            <HStack justify="space-between" align="center" mb={2}>
                              <HStack>
                                <Box
                                  ...
                                  border="2px solid"
                                  borderColor={
                                    isAchieved ? 'green.500' : isNext ? 'orange.500' : 'gray.300'
                                  }
                                />
                                <Text
                                  fontSize="sm"
                                  ...
                                  color={
                                    isAchieved ? 'green.600' : isNext ? 'orange.600' : 'gray.600'
                                  }
                                >
                                  {milestone.name}
                                </Text>
                            ...
                            {isNext && (
                              <Box ml={6}>
                                ...
                                <Text fontSize="xs" color="gray.500" mt={1}>
                                  {activityProgress} / {milestone.value}{' '}
                                  {activityType?.unitLabel || 'points'}
                                </Text>
                              </Box>
                            )}
