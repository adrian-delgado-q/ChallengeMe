...
export const EditProfileModal: React.FC<EditProfileModalProps> = ({
    ...
    const generateAvatarOptions = () => {
        ...
        const options = AVATAR_STYLES.slice(0, 12).map(style =>
            generateAvatarUrl(style, seed)
        );
            ...
            <ModalContent>
                ...
                <ModalBody>
                    <VStack spacing={6}>
                        ...
                        <FormControl
                            isRequired
                            isInvalid={usernameStatus.error ? true : (username !== profile?.username && !usernameStatus.isAvailable)}
                        >
                            ...
                            {usernameStatus.error && (
                                <FormErrorMessage>{usernameStatus.error}</FormErrorMessage>
                            )}
                            ...
                            {username === profile?.username && (
                                <FormHelperText>Current username</FormHelperText>
                            )}
                        </FormControl>
