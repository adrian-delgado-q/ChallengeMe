...
export const Header: React.FC = () => {
	...
	const renderUserActions = () => {
				...
				<HStack spacing={4}>
					...
					<Menu>
						...
						<MenuList zIndex="popover">
							...
							<MenuItem onClick={() => navigate('/activities')}>My Activities</MenuItem>
							<MenuItem onClick={() => navigate('/my-challenges')}>My Challenges</MenuItem>
							<MenuDivider />
		...
		return (
			<Button colorScheme="orange" variant="solid" onClick={() => navigate('/auth')}>
				Login / Sign Up
			</Button>
		);
	};
				...
				{user && (
					<>
						...
						<HStack spacing={6} display={{ base: 'none', md: 'flex' }}>
							...
							<Link onClick={() => navigate('/teams')} fontWeight="bold" _hover={{ color: 'orange.500' }}>
								Teams
							</Link>
						</HStack>
