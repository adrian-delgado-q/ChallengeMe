...
export class DiscussionService {
    ...
    static async getUserPermissions(challengeId: string, userId?: string): Promise<DiscussionPermissions> {
        if (!userId) {
            return {
                canPost: false,
                canReply: false,
    ...
    static async banUser(challengeId: string, userId: string, reason?: string, expiresAt?: string): Promise<void> {
