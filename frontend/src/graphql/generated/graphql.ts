...
export type ChallengeParticipantType = 'INDIVIDUAL' | 'TEAM';

export type ChallengeStatus = 'ACTIVE' | 'CANCELLED' | 'CLOSED';
...
export type MasteryTier = 'ADEPT' | 'EXPERT' | 'GRANDMASTER' | 'MASTER' | 'NOVICE';
