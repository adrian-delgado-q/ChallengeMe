...
export type DiscussionBanDetailsFragment = {
...
export type GetDiscussionBansQuery = {
	__typename?: 'Query';
	discussionBans?: Array<{
		__typename?: 'DiscussionBan';
		id?: string | null;
		challenge_id?: string | null;
		user_id?: string | null;
...
export type BanFromDiscussionMutation = {
	__typename?: 'Mutation';
	banFromDiscussion?: {
		__typename?: 'DiscussionBan';
		id?: string | null;
...
export type UnbanFromDiscussionMutation = {
	__typename?: 'Mutation';
	unbanFromDiscussion?: {
		__typename?: 'DiscussionBan';
		id?: string | null;
...
export const useGetDiscussionBansQuery = <TData = GetDiscussionBansQuery, TError = unknown>(
	dataSource: { endpoint: string; fetchParams?: RequestInit },
	variables: GetDiscussionBansQueryVariables,
	options?: Omit<UseQueryOptions<GetDiscussionBansQuery, TError, TData>, 'queryKey'> & {
		queryKey?: UseQueryOptions<GetDiscussionBansQuery, TError, TData>['queryKey'];
	}
) => {
	return useQuery<GetDiscussionBansQuery, TError, TData>({
		queryKey: ['GetDiscussionBans', variables],
		queryFn: fetcher<GetDiscussionBansQuery, GetDiscussionBansQueryVariables>(
			dataSource.endpoint,
			dataSource.fetchParams || {},
			GetDiscussionBansDocument,
			variables
		),
		...options,
	});
...
export const useBanFromDiscussionMutation = <TError = unknown, TContext = unknown>(
	dataSource: { endpoint: string; fetchParams?: RequestInit },
	options?: UseMutationOptions<
		BanFromDiscussionMutation,
		TError,
		BanFromDiscussionMutationVariables,
		TContext
	>
) => {
	return useMutation<
	...
	>({
		...
		mutationFn: (variables?: BanFromDiscussionMutationVariables) =>
			fetcher<BanFromDiscussionMutation, BanFromDiscussionMutationVariables>(
				dataSource.endpoint,
				dataSource.fetchParams || {},
				BanFromDiscussionDocument,
				variables
			)(),
		...options,
	});
...
export const useUnbanFromDiscussionMutation = <TError = unknown, TContext = unknown>(
	dataSource: { endpoint: string; fetchParams?: RequestInit },
	options?: UseMutationOptions<
		UnbanFromDiscussionMutation,
		TError,
		UnbanFromDiscussionMutationVariables,
		TContext
	>
) => {
	return useMutation<
	...
	>({
		...
		mutationFn: (variables?: UnbanFromDiscussionMutationVariables) =>
			fetcher<UnbanFromDiscussionMutation, UnbanFromDiscussionMutationVariables>(
				dataSource.endpoint,
				dataSource.fetchParams || {},
				UnbanFromDiscussionDocument,
				variables
			)(),
		...options,
	});
