...
export type BadgeBasicFragment = { __typename?: 'Badge', id?: string | null, name?: string | null, description?: string | null, category?: string | null, icon_url?: string | null, xp_bonus?: number | null, created_at?: string | null };
...
export type GetBadgeQuery = { __typename?: 'Query', badge?: { __typename?: 'Badge', id?: string | null, name?: string | null, description?: string | null, category?: string | null, icon_url?: string | null, xp_bonus?: number | null, created_at?: string | null } | null };

export type GetBadgesQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type GetBadgesQuery = { __typename?: 'Query', badges?: Array<{ __typename?: 'Badge', id?: string | null, name?: string | null, description?: string | null, category?: string | null, icon_url?: string | null, xp_bonus?: number | null, created_at?: string | null }> | null };
...
export type CreateBadgeMutation = { __typename?: 'Mutation', createBadge?: { __typename?: 'Badge', id?: string | null, name?: string | null, description?: string | null, category?: string | null, icon_url?: string | null, xp_bonus?: number | null, created_at?: string | null } | null };
...
export type UpdateBadgeMutation = { __typename?: 'Mutation', updateBadge?: { __typename?: 'Badge', id?: string | null, name?: string | null, description?: string | null, category?: string | null, icon_url?: string | null, xp_bonus?: number | null, created_at?: string | null } | null };
...
export type DeleteBadgeMutation = { __typename?: 'Mutation', deleteBadge?: { __typename?: 'Badge', id?: string | null } | null };
...
export const useGetBadgeQuery = <
    ...
    >(
      ...
      options?: Omit<UseQueryOptions<GetBadgeQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<GetBadgeQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<GetBadgeQuery, TError, TData>(
      {
    queryKey: ['GetBadge', variables],
    queryFn: fetcher<GetBadgeQuery, GetBadgeQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, GetBadgeDocument, variables),
    ...options
  }
    )};
...
export const useGetBadgesQuery = <
    ...
    queryFn: fetcher<GetBadgesQuery, GetBadgesQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, GetBadgesDocument, variables),
    ...options
  }
    )};
...
export const useCreateBadgeMutation = <
    ...
    mutationFn: (variables?: CreateBadgeMutationVariables) => fetcher<CreateBadgeMutation, CreateBadgeMutationVariables>(dataSource.endpoint, dataSource.fetchParams || {}, CreateBadgeDocument, variables)(),
    ...options
  }
    )};
...
export const useUpdateBadgeMutation = <
    ...
    mutationFn: (variables?: UpdateBadgeMutationVariables) => fetcher<UpdateBadgeMutation, UpdateBadgeMutationVariables>(dataSource.endpoint, dataSource.fetchParams || {}, UpdateBadgeDocument, variables)(),
    ...options
  }
    )};
...
export const useDeleteBadgeMutation = <
    ...
    mutationFn: (variables?: DeleteBadgeMutationVariables) => fetcher<DeleteBadgeMutation, DeleteBadgeMutationVariables>(dataSource.endpoint, dataSource.fetchParams || {}, DeleteBadgeDocument, variables)(),
    ...options
  }
    )};
