...
export type TeamCreatorFragment = {
	__typename?: 'Profile';
	id?: string | null;
...
export type TeamBasicFragment = {
	...
	sports_types?: Array<string> | null;
	created_at?: string | null;
	expires_at?: string | null;
};

export type TeamFullFragment = {
	__typename?: 'Team';
	id?: string | null;
	name?: string | null;
	description?: string | null;
...
export const useGetMyTeamsQuery = <TData = GetMyTeamsQuery, TError = unknown>(
	dataSource: { endpoint: string; fetchParams?: RequestInit },
	variables: GetMyTeamsQueryVariables,
	options?: Omit<UseQueryOptions<GetMyTeamsQuery, TError, TData>, 'queryKey'> & {
		queryKey?: UseQueryOptions<GetMyTeamsQuery, TError, TData>['queryKey'];
	}
) => {
	return useQuery<GetMyTeamsQuery, TError, TData>({
		queryKey: ['GetMyTeams', variables],
		queryFn: fetcher<GetMyTeamsQuery, GetMyTeamsQueryVariables>(
			dataSource.endpoint,
			dataSource.fetchParams || {},
			GetMyTeamsDocument,
			variables
...
export const useCreateTeamMutation = <TError = unknown, TContext = unknown>(
	...
	return useMutation<CreateTeamMutation, TError, CreateTeamMutationVariables, TContext>({
		...
		mutationFn: (variables?: CreateTeamMutationVariables) =>
...
export const useUpdateTeamMutation = <TError = unknown, TContext = unknown>(
	...
	return useMutation<UpdateTeamMutation, TError, UpdateTeamMutationVariables, TContext>({
		...
		mutationFn: (variables?: UpdateTeamMutationVariables) =>
...
export const useDeleteTeamMutation = <TError = unknown, TContext = unknown>(
	...
	return useMutation<DeleteTeamMutation, TError, DeleteTeamMutationVariables, TContext>({
		...
		mutationFn: (variables?: DeleteTeamMutationVariables) =>
...
export const useAddTeamMemberMutation = <TError = unknown, TContext = unknown>(
	dataSource: { endpoint: string; fetchParams?: RequestInit },
	...
	return useMutation<AddTeamMemberMutation, TError, AddTeamMemberMutationVariables, TContext>({
		...
		mutationFn: (variables?: AddTeamMemberMutationVariables) =>
			fetcher<AddTeamMemberMutation, AddTeamMemberMutationVariables>(
				dataSource.endpoint,
				dataSource.fetchParams || {},
...
export const useRemoveTeamMemberMutation = <TError = unknown, TContext = unknown>(
	dataSource: { endpoint: string; fetchParams?: RequestInit },
	options?: UseMutationOptions<
	...
	return useMutation<RemoveTeamMemberMutation, TError, RemoveTeamMemberMutationVariables, TContext>({
		...
		mutationFn: (variables?: RemoveTeamMemberMutationVariables) =>
			fetcher<RemoveTeamMemberMutation, RemoveTeamMemberMutationVariables>(
				dataSource.endpoint,
				dataSource.fetchParams || {},
