...
export type WorkoutExerciseDetailsFragment = {
...
export type GetWorkoutExercisesQuery = {
	__typename?: 'Query';
...
export type RemoveExerciseFromWorkoutMutation = {
	__typename?: 'Mutation';
	removeExerciseFromWorkout?: { __typename?: 'WorkoutExercise'; id?: string | null } | null;
};
...
export const useGetWorkoutExercisesQuery = <TData = GetWorkoutExercisesQuery, TError = unknown>(
	dataSource: { endpoint: string; fetchParams?: RequestInit },
	variables: GetWorkoutExercisesQueryVariables,
	options?: Omit<UseQueryOptions<GetWorkoutExercisesQuery, TError, TData>, 'queryKey'> & {
		queryKey?: UseQueryOptions<GetWorkoutExercisesQuery, TError, TData>['queryKey'];
	}
) => {
	return useQuery<GetWorkoutExercisesQuery, TError, TData>({
		queryKey: ['GetWorkoutExercises', variables],
		queryFn: fetcher<GetWorkoutExercisesQuery, GetWorkoutExercisesQueryVariables>(
			dataSource.endpoint,
			dataSource.fetchParams || {},
			GetWorkoutExercisesDocument,
			variables
		),
		...options,
	});
...
export const useAddExerciseToWorkoutMutation = <TError = unknown, TContext = unknown>(
	dataSource: { endpoint: string; fetchParams?: RequestInit },
	...
	>({
		...
		mutationFn: (variables?: AddExerciseToWorkoutMutationVariables) =>
			fetcher<AddExerciseToWorkoutMutation, AddExerciseToWorkoutMutationVariables>(
				dataSource.endpoint,
				dataSource.fetchParams || {},
				AddExerciseToWorkoutDocument,
				variables
			)(),
		...options,
	});
...
export const useUpdateWorkoutExerciseMutation = <TError = unknown, TContext = unknown>(
	dataSource: { endpoint: string; fetchParams?: RequestInit },
	options?: UseMutationOptions<
		UpdateWorkoutExerciseMutation,
		TError,
		UpdateWorkoutExerciseMutationVariables,
		TContext
	>
) => {
	return useMutation<
	...
	>({
		...
		mutationFn: (variables?: UpdateWorkoutExerciseMutationVariables) =>
			fetcher<UpdateWorkoutExerciseMutation, UpdateWorkoutExerciseMutationVariables>(
				dataSource.endpoint,
				dataSource.fetchParams || {},
				UpdateWorkoutExerciseDocument,
				variables
			)(),
		...options,
	});
...
export const useRemoveExerciseFromWorkoutMutation = <TError = unknown, TContext = unknown>(
	dataSource: { endpoint: string; fetchParams?: RequestInit },
	options?: UseMutationOptions<
		RemoveExerciseFromWorkoutMutation,
		TError,
		RemoveExerciseFromWorkoutMutationVariables,
		TContext
	>
) => {
	return useMutation<
	...
	>({
		...
		mutationFn: (variables?: RemoveExerciseFromWorkoutMutationVariables) =>
			fetcher<RemoveExerciseFromWorkoutMutation, RemoveExerciseFromWorkoutMutationVariables>(
				dataSource.endpoint,
				dataSource.fetchParams || {},
				RemoveExerciseFromWorkoutDocument,
				variables
			)(),
		...options,
	});
