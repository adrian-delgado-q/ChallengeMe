...
export type PostWithRelationsFragment = {
	__typename?: 'Post';
	id?: string | null;
	content?: string | null;
	image_url?: string | null;
...
export type DeleteCommentMutation = {
	__typename?: 'Mutation';
	deleteComment?: { __typename?: 'Comment'; id?: string | null } | null;
};
...
export const useGetPostsQuery = <TData = GetPostsQuery, TError = unknown>(
	...
	return useQuery<GetPostsQuery, TError, TData>({
		...
		queryFn: fetcher<GetPostsQuery, GetPostsQueryVariables>(
			dataSource.endpoint,
...
export const useGetPostQuery = <TData = GetPostQuery, TError = unknown>(
	...
	return useQuery<GetPostQuery, TError, TData>({
		...
		queryFn: fetcher<GetPostQuery, GetPostQueryVariables>(
			dataSource.endpoint,
			dataSource.fetchParams || {},
			GetPostDocument,
			variables
...
export const useUpdatePostMutation = <TError = unknown, TContext = unknown>(
	...
	return useMutation<UpdatePostMutation, TError, UpdatePostMutationVariables, TContext>({
		...
		mutationFn: (variables?: UpdatePostMutationVariables) =>
...
export const useDeletePostMutation = <TError = unknown, TContext = unknown>(
	...
	return useMutation<DeletePostMutation, TError, DeletePostMutationVariables, TContext>({
		...
		mutationFn: (variables?: DeletePostMutationVariables) =>
