...
export type ActivityTypeBasicFragment = {
...
export type ActivityBasicFragment = {
	__typename?: 'Activity';
	id?: string | null;
	value?: number | null;
	notes?: string | null;
...
export type ActivityWithRelationsFragment = {
	__typename?: 'Activity';
	id?: string | null;
	value?: number | null;
	notes?: string | null;
...
export type DeleteActivityMutation = {
	__typename?: 'Mutation';
	deleteActivity?: { __typename?: 'Activity'; id?: string | null } | null;
};
...
export const useGetActivitiesQuery = <TData = GetActivitiesQuery, TError = unknown>(
	dataSource: { endpoint: string; fetchParams?: RequestInit },
	variables?: GetActivitiesQueryVariables,
	options?: Omit<UseQueryOptions<GetActivitiesQuery, TError, TData>, 'queryKey'> & {
	...
	return useQuery<GetActivitiesQuery, TError, TData>({
		...
		queryFn: fetcher<GetActivitiesQuery, GetActivitiesQueryVariables>(
			dataSource.endpoint,
...
export const useGetActivityQuery = <TData = GetActivityQuery, TError = unknown>(
	...
	options?: Omit<UseQueryOptions<GetActivityQuery, TError, TData>, 'queryKey'> & {
...
export const useCreateActivityMutation = <TError = unknown, TContext = unknown>(
	...
	return useMutation<CreateActivityMutation, TError, CreateActivityMutationVariables, TContext>({
		...
		mutationFn: (variables?: CreateActivityMutationVariables) =>
			fetcher<CreateActivityMutation, CreateActivityMutationVariables>(
				dataSource.endpoint,
				dataSource.fetchParams || {},
...
export const useUpdateActivityMutation = <TError = unknown, TContext = unknown>(
	...
	return useMutation<UpdateActivityMutation, TError, UpdateActivityMutationVariables, TContext>({
		...
		mutationFn: (variables?: UpdateActivityMutationVariables) =>
			fetcher<UpdateActivityMutation, UpdateActivityMutationVariables>(
				dataSource.endpoint,
				dataSource.fetchParams || {},
...
export const useDeleteActivityMutation = <TError = unknown, TContext = unknown>(
	dataSource: { endpoint: string; fetchParams?: RequestInit },
	options?: UseMutationOptions<
	...
	return useMutation<DeleteActivityMutation, TError, DeleteActivityMutationVariables, TContext>({
		...
		mutationFn: (variables?: DeleteActivityMutationVariables) =>
			fetcher<DeleteActivityMutation, DeleteActivityMutationVariables>(
				dataSource.endpoint,
				dataSource.fetchParams || {},
