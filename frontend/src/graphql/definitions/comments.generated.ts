...
export const useGetCommentsQuery = <TData = GetCommentsQuery, TError = unknown>(
	...
	options?: Omit<UseQueryOptions<GetCommentsQuery, TError, TData>, 'queryKey'> & {
	...
	return useQuery<GetCommentsQuery, TError, TData>({
		...
		queryFn: fetcher<GetCommentsQuery, GetCommentsQueryVariables>(
			dataSource.endpoint,
...
export const useUpdateCommentMutation = <TError = unknown, TContext = unknown>(
	...
	return useMutation<UpdateCommentMutation, TError, UpdateCommentMutationVariables, TContext>({
		...
		mutationFn: (variables?: UpdateCommentMutationVariables) =>
