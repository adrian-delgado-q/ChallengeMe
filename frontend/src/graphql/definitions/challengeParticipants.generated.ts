...
export type CreateChallengeParticipantMutation = {
	__typename?: 'Mutation';
...
export type DeleteChallengeParticipantMutation = {
	__typename?: 'Mutation';
...
>(
	...
	options?: Omit<UseQueryOptions<GetChallengeParticipantsQuery, TError, TData>, 'queryKey'> & {
		queryKey?: UseQueryOptions<GetChallengeParticipantsQuery, TError, TData>['queryKey'];
	}
) => {
	return useQuery<GetChallengeParticipantsQuery, TError, TData>({
		queryKey:
			variables === undefined ? ['GetChallengeParticipants'] : ['GetChallengeParticipants', variables],
		queryFn: fetcher<GetChallengeParticipantsQuery, GetChallengeParticipantsQueryVariables>(
			dataSource.endpoint,
			dataSource.fetchParams || {},
			GetChallengeParticipantsDocument,
			variables
		),
		...options,
	});
...
export const useCreateChallengeParticipantMutation = <TError = unknown, TContext = unknown>(
	dataSource: { endpoint: string; fetchParams?: RequestInit },
	options?: UseMutationOptions<
		CreateChallengeParticipantMutation,
		TError,
		CreateChallengeParticipantMutationVariables,
		TContext
	>
) => {
	return useMutation<
	...
	>({
		...
		mutationFn: (variables?: CreateChallengeParticipantMutationVariables) =>
			fetcher<CreateChallengeParticipantMutation, CreateChallengeParticipantMutationVariables>(
				dataSource.endpoint,
				dataSource.fetchParams || {},
				CreateChallengeParticipantDocument,
				variables
			)(),
		...options,
	});
...
export const useDeleteChallengeParticipantMutation = <TError = unknown, TContext = unknown>(
	dataSource: { endpoint: string; fetchParams?: RequestInit },
	options?: UseMutationOptions<
		DeleteChallengeParticipantMutation,
		TError,
		DeleteChallengeParticipantMutationVariables,
		TContext
	>
) => {
	return useMutation<
	...
	>({
		...
		mutationFn: (variables?: DeleteChallengeParticipantMutationVariables) =>
			fetcher<DeleteChallengeParticipantMutation, DeleteChallengeParticipantMutationVariables>(
				dataSource.endpoint,
				dataSource.fetchParams || {},
				DeleteChallengeParticipantDocument,
				variables
			)(),
		...options,
	});
