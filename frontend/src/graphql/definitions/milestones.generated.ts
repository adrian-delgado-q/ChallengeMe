...
export type MilestoneDetailsFragment = {
...
export type DeleteMilestoneMutation = {
	__typename?: 'Mutation';
	deleteMilestone?: { __typename?: 'Milestone'; id?: string | null } | null;
};
...
export const useGetMilestoneQuery = <TData = GetMilestoneQuery, TError = unknown>(
	dataSource: { endpoint: string; fetchParams?: RequestInit },
	variables: GetMilestoneQueryVariables,
	options?: Omit<UseQueryOptions<GetMilestoneQuery, TError, TData>, 'queryKey'> & {
		queryKey?: UseQueryOptions<GetMilestoneQuery, TError, TData>['queryKey'];
	}
) => {
	return useQuery<GetMilestoneQuery, TError, TData>({
		queryKey: ['GetMilestone', variables],
		queryFn: fetcher<GetMilestoneQuery, GetMilestoneQueryVariables>(
			dataSource.endpoint,
...
export const useGetMilestonesQuery = <TData = GetMilestonesQuery, TError = unknown>(
	dataSource: { endpoint: string; fetchParams?: RequestInit },
	variables?: GetMilestonesQueryVariables,
	options?: Omit<UseQueryOptions<GetMilestonesQuery, TError, TData>, 'queryKey'> & {
		queryKey?: UseQueryOptions<GetMilestonesQuery, TError, TData>['queryKey'];
	}
) => {
	return useQuery<GetMilestonesQuery, TError, TData>({
		queryKey: variables === undefined ? ['GetMilestones'] : ['GetMilestones', variables],
		queryFn: fetcher<GetMilestonesQuery, GetMilestonesQueryVariables>(
			dataSource.endpoint,
			dataSource.fetchParams || {},
...
export const useCreateMilestoneMutation = <TError = unknown, TContext = unknown>(
	dataSource: { endpoint: string; fetchParams?: RequestInit },
...
export const useUpdateMilestoneMutation = <TError = unknown, TContext = unknown>(
	dataSource: { endpoint: string; fetchParams?: RequestInit },
	options?: UseMutationOptions<
	...
	return useMutation<UpdateMilestoneMutation, TError, UpdateMilestoneMutationVariables, TContext>({
		...
		mutationFn: (variables?: UpdateMilestoneMutationVariables) =>
			fetcher<UpdateMilestoneMutation, UpdateMilestoneMutationVariables>(
				dataSource.endpoint,
				dataSource.fetchParams || {},
...
export const useDeleteMilestoneMutation = <TError = unknown, TContext = unknown>(
	dataSource: { endpoint: string; fetchParams?: RequestInit },
	options?: UseMutationOptions<
	...
	return useMutation<DeleteMilestoneMutation, TError, DeleteMilestoneMutationVariables, TContext>({
		...
		mutationFn: (variables?: DeleteMilestoneMutationVariables) =>
			fetcher<DeleteMilestoneMutation, DeleteMilestoneMutationVariables>(
				dataSource.endpoint,
				dataSource.fetchParams || {},
