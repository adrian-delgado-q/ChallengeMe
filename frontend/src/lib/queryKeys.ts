...
export const queryKeys = {
  ...
  activities: {
    ...
    challengeActivities: (challengeId: string) => [...queryKeys.activities.all, 'challenge', challengeId] as const,
  },
  ...
  discussions: {
    ...
    challengeDiscussions: (challengeId: string) => [...queryKeys.discussions.all, 'challenge', challengeId] as const,
  },
  ...
  posts: {
    ...
    discussionPosts: (discussionId: string) => [...queryKeys.posts.all, 'discussion', discussionId] as const,
  },
