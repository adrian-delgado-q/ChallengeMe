...
import {
    ...
    Stat, StatLabel, StatNumber, useDisclosure, Spinner,
    Center, Alert, AlertIcon,
    Table, Thead, Tbody, Tr, Th, Td, Avatar, IconButton,
    ...
    SimpleGrid, Progress, useColorModeValue
        ...
        <VStack spacing={8} align="stretch">
            ...
            <Box>
                <HStack justify="space-between" align="start" wrap="wrap" gap={4}>
                    <VStack align="start" spacing={2}>
                        <Heading as="h1" size="xl">{challenge.title}</Heading>
                        <HStack spacing={4}>
                        ...
                        {challenge.description && (
                            <Text color="gray.600" maxW="2xl">{challenge.description}</Text>
                        )}
                    </VStack>
            ...
            {analytics && (
                <Card p={6} bg={cardBg} borderColor={borderColor}>
                    <Heading size="md" mb={4}>Challenge Analytics</Heading>
            ...
            {/* Challenge Progress */}
            <Card p={6} bg={cardBg} borderColor={borderColor}>
                <Heading size="md" mb={4}>Challenge Progress</Heading>
                <VStack spacing={4}>
                    <Box w="full">
            ...
            <Card p={6} bg={cardBg} borderColor={borderColor}>
                <Heading size="md" mb={4}>Participants ({participants.length})</Heading>
                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        <VStack spacing={4} align="stretch">
                            <Text>Current status: <Badge colorScheme={getStatusColor(challenge.status || 'ACTIVE')}>
                                {getStatusText(challenge.status || 'ACTIVE')}
                            </Badge></Text>
                ...
                <AlertDialogOverlay>
                    <AlertDialogContent>
                        ...
                        <AlertDialogBody>
                            ...
                            <strong>
                                {selectedParticipant?.user?.username || selectedParticipant?.team?.name}
                            </strong>{' '}
