...
export const ActivityManagementPage: React.FC = () => {
  ...
  const getEditableStatus = (activity: Activity) => {
    ...
    const hoursLeft = Math.max(
      ...
      48 -
        Math.floor(
          (new Date().getTime() - new Date(activity.uploadedAt).getTime()) / (1000 * 60 * 60)
        )
    );
      ...
      <VStack spacing={6} align="stretch">
                      ...
                      <VStack align="start" spacing={2} flex={1}>
                        <HStack spacing={2} align="center">
                          <Text
                            ...
                            onClick={() =>
                              ...
                              navigate(`/challenges/${activity.challenge.id}`)
                            }
                            _hover={
                              activity.challenge?.id
                                ? { color: 'blue.800', textDecoration: 'underline' }
                                : {}
                            }
                            transition="all 0.2s"
                          >
                        ...
                        <HStack spacing={2} align="center">
                          ...
                          <Badge colorScheme="blue" variant="outline">
                            {activity.value}{' '}
                            {activity.activityType?.unitLabel ||
                    ...
                    <HStack spacing={2}>
                      <Tooltip
                        label={
                          activity.isEditable
                            ? 'Edit activity'
                            : 'Activity can no longer be edited (48h limit)'
                        }
                      >
                        <IconButton
        ...
        <Alert status="info" variant="left-accent">
          ...
          <VStack align="start" spacing={1}>
            ...
            <Text fontSize="sm">
              • Activities can only be edited or deleted within 48 hours of being logged • After 48
              hours, activities become read-only for data integrity • Use filters to find specific
              activities across your challenges
            </Text>
          </VStack>
        </Alert>
      </VStack>
