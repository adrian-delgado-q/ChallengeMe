...
import {
    Box, Heading, Text, VStack, HStack, Card, Badge, Button,
    Stat, StatLabel, StatNumber, useColorModeValue, Spinner,
    Center, IconButton, Menu, MenuButton, MenuList, MenuItem,
    SimpleGrid, Progress, Flex, Wrap, WrapItem
        ...
        <VStack spacing={8} align="stretch">
            ...
            <Flex justify="space-between" align="center" wrap="wrap" gap={4}>
                <VStack align="start" spacing={2}>
                    <Heading as="h1" size="xl">My Challenges</Heading>
            ...
            {challenges.length === 0 ? (
                <Card p={12} textAlign="center" bg={cardBg} borderColor={borderColor}>
                    <VStack spacing={6}>
                        <Heading size="lg" color="gray.500">No Challenges Yet</Heading>
                        <Text color="gray.600" maxW="md">
                            You haven't created any challenges yet. Create your first challenge to start building a community around your fitness goals.
                        </Text>
                        <Button
                            leftIcon={<AddIcon />}
                            colorScheme="orange"
                ...
                <SimpleGrid columns={{ base: 1, md: 2, lg: 3 }} spacing={6}>
                    {challenges.map((challenge) => (
                        <Card key={challenge.id} p={6} bg={cardBg} borderColor={borderColor} transition="all 0.2s" _hover={{ shadow: 'lg' }}>
                            <VStack spacing={4} align="stretch">
                                {/* Header */}
                                <HStack justify="space-between" align="start">
                                    <VStack align="start" spacing={1} flex="1">
                                        <Heading size="md" noOfLines={2}>{challenge.title}</Heading>
                                        <HStack spacing={2}>
                                ...
                                {challenge.participantList.length > 0 && (
                                    <VStack spacing={2} align="stretch">
                                        <Text fontSize="sm" fontWeight="medium">Recent Participants</Text>
                                        <Wrap spacing={1}>
